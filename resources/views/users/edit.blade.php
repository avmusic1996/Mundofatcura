              ...
              <div class="card-footer ml-auto mr-auto">
                <div class="row">
                  <div class="col-md-6 p-2">
                    <button type="submit" class="btn col-md-12 btn-primary">Actualizar</button>
                  </div>
                  <div class="col-md-6 p-2">
                    <a href="{{ route('users.index') }}" class="btn col-md-12 btn-danger"><i class="material-icons">Cancelar</i></a>
                  </div>
                </div>
              </div>
              <!--End footer-->
