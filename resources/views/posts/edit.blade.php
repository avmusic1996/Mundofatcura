        ...
        <form method="POST" action="{{ route('posts.update', $post->id) }}" class="form-horizontal">
          ...
          <div class="card">
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="title" placeholder="Ingrese el title"
                    value="{{ old('title', $post->title) }}" autocomplete="off" autofocus required="">
                </div>
              </div>
            </div>
            <!--End body-->
            ...
            <div class="card-footer ml-auto mr-auto">
              ...
              <a href="{{ route('posts.index', $post->id) }}" class="btn btn-success"> <i
                class="material-icons"></i>Cancelar</a>
            </div>
          </div>
          <!--End footer-->
        </form>
